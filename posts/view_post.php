    ...
    <div class="container">
        <div class="card rounded-0 shadow">
            <div class="card-header">
                <h4 class="card-title">Detalles de la publicación</h4>
                <?php if($_settings->userdata('id') == $user_id): ?>
                    <div class="card-tools">
                        <a href="./?p=posts/manage_post&id=<?= $id ?>" class="btn btn-sm btn-flat bg-gradient-primary btn-primary"><i class="fa fa-edit"></i> Editar Posts</a>
                        <button type="button" id="delete_post" class="btn btn-sm btn-flat bg-gradient-danger btn-danger"><i class="fa fa-trash"></i> Eliminar</button>
                    </div>
                <?php endif; ?>
            </div>
            <div class="card-body">
                <div class="contrain-fluid">
                    ...
                    <div class="mb-2 text-right">
                        <?php if($status == 1): ?>
                            <small class="badge badge-light border text-dark rounded-pill px-3"><i class="fa fa-circle text-primary"></i> Publicados</small>
                        <?php else: ?>
                            <small class="badge badge-light border text-dark rounded-pill px-3"><i class="fa fa-circle text-secondary"></i> Sin Publicar</small>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                    ...
                    <hr class="mx-n3">
                    <h4 class="font-weight-bolder">Comentarios:</h4>
                    ...
                    <?php if($_settings->userdata('id') == ''): ?>
                        <h5 class="text-center text-muted"><i>Iniciar sesión para publicar un comentario</i></h5>
                    <?php else: ?>
                    <div class="card rounded-0 shadow">
                        <div class="card-body">
                            <div class="container-fluid">
                                <form action="" id="comment-form">
                                    ...
                                    <textarea class="form-control form-control-sm rouned-0" name="comment" id="comment" rows="4" placeholder="Escribe tu comentario aquí"></textarea>
                                </form>
                            </div>
                        </div>
                        <div class="card-footer py-1 text-right">
                                <button class="btn btn-primary btn-flat btn-sm bg-gradient-primary" form="comment-form"><i class="fa fa-save"></i> Guardar</button>
                                <button class="btn btn-light btn-flat btn-sm bg-gradient-light border" type="reset" form="comment-form">Cancelar</button>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
