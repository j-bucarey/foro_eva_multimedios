...
<section class="py-3">
    <div class="container">
        <div class="row justify-content-center mb-4">
            <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                <div class="input-group input-group-lg" id="search-field">
                    <input type="search" class="form-control form-control-lg  rounded-pill" aria-label="Search Post Input" id="search" placeholder="Buscar post aquí">
        ...
        <?php if($posts->num_rows <= 0): ?>
            <h4 class="text-muted text-center"><i>Todavía no tienes registros de publicaciones</i></h4>
        <?php endif; ?>
    </div>
</section>
<script>
