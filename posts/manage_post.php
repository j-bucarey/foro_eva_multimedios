    ...
    <div class="container">
        <div class="card rounded-0 shadow">
            <div class="card-header">
                <h5 class="card-title"><?= !isset($id) ? "Agregar nuevo tema" : "Detalles del tema de actualización" ?></h5>
            </div>
            <div class="card-body">
            ...
            <div class="card-footer py-1 text-center">
                <button class="btn btn-flat btn-sm btn-primary bg-gradient-primary rounded-0" form="post-form"><i class="fa fa-save"></i> Guardar</button>
                <a class="btn btn-flat btn-sm btn-light bg-gradient-light border rounded-0" href="./?p=posts"><i class="fa fa-angle-left"></i> Cancelar|</a>
            </div>
        </div>
    </div>
</section>
<script>
    $(function(){
        $('#category_id').select2({
            placeholder:"Por favor, seleccione la categoría aquí",
            width:'100%',
