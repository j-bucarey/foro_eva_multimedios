	...
	<div class="container">
		<div class="card card-outline rounded-0 card-navy">
			<div class="card-header">
				<h4 class="font-weight-bolder">Actualizar detalles del usuario</h4>
			</div>
			<div class="card-body">
					...
					<form action="" id="manage-user">	
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<small class="text-muted"><i>Deje los campos de contraseña en blanco si no desea actualizar su contraseña.</i></small>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									...
									<div class="custom-file">
										...
										<label class="custom-file-label rounded-0" for="customFile">Eligir Archivo</label>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-sm btn-primary btn-sm btn-flat" form="manage-user">Actualizar</button>
			</div>
		</div>
	</div>
</section>
