...
<div class="col-lg-12">
	<div class="card card-outline rounded-0 card-navy">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Sobre nosotros</label>
			...
			<div class="form-group">
				...
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile1">Elegir archivo</label>
	            </div>
			</div>
			...
			<div class="form-group">
				<label for="" class="control-label">Portada del sitio web</label>
				<div class="custom-file">
			...
			<div class="form-group">
				<label for="" class="control-label">Banner Imagenes</label>
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile3">Elegir archivo</label>
	            </div>
				<small><i>Elige subir nuevos banners immages</i></small>
			</div>
			<?php 
...
<script>
	...
	function delete_img($path){
        ...
        $.ajax({
            ...
            error:err=>{
                console.log(err)
                alert_toast("Se ha producido un error al eliminar una imagen","error");
                end_loader()
            },
            success:function(resp){
                ...
                if(typeof resp =='object' && resp.status == 'success'){
                    ...
                    alert_toast("Imagen eliminada correctamente","success");
                }else{
                    console.log(resp)
                    alert_toast("Se ha producido un error al eliminar una imagen","error");
                }
	...
	$(document).ready(function(){
		$('.rem_img').click(function(){
            _conf("¿Está seguro de eliminar esta imagen de forma permanente?",'delete_img',["'"+$(this).attr('data-path')+"'"])
        })
