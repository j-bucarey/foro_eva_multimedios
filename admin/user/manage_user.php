	...
	<div class="card-body">
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					<label for="password"><?= isset($meta['id']) ? "New" : "" ?> Contraseña</label>
					<input type="password" name="password" id="password" class="form-control" value="" autocomplete="off">
                    <?php if(isset($meta['id'])): ?>
					<small><i>Deja esto en blanco si no quieres cambiar la contraseña.</i></small>
                    <?php endif; ?>
				</div>
                <div class="form-group">
                    ...
                    <option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Usuario Registrado</option>
                    </select>
                </div>
				<div class="form-group">
